...
function mountComponent(vnode, container, options, anchor) {
    ...
    let { render: new_render, setupState } = handleSetup(setup, render, instance, attrs);
    if (!setupState) {
...
// 处理 setup 函数
function handleSetup(setup, render, instance, attrs) {
...
export { NodeFlags, createRenderer, effect, patch, reactive, ref, shallowReactive };
